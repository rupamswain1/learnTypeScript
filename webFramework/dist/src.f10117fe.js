...
var Views = /*#__PURE__*/function () {
  ...
  _createClass(Views, [{
    ...
    key: "bindEvents",
    value: function bindEvents(fragments) {
...
var UserForms = /*#__PURE__*/function (_Views_1$Views) {
  _inherits(UserForms, _Views_1$Views);

  var _super = _createSuper(UserForms);
...
},{"./Views":"src/views/Views.ts"}],"src/Models/Eventing.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function Eventing() {
    ...
    this.trigger = function (eventName) {
      var eventList = _this.events[eventName];
...
function () {
  function Sync(rootUrl) {
    ...
    this.save = function (data) {
      if (data.id) {
        return axios_1.default.put(_this.rootUrl + "/" + data.id, data);
      } else {
...
/** @class */
function () {
  function Models(events, sync, attributes) {
    this.events = events;
    this.sync = sync;
    this.attributes = attributes;
  }

  Object.defineProperty(Models.prototype, "on", {
    get: function get() {
  ...
  Object.defineProperty(Models.prototype, "trigger", {
    get: function get() {
  ...
  Object.defineProperty(Models.prototype, "get", {
    get: function get() {
...
},{"./Eventing":"src/Models/Eventing.ts","axios":"node_modules/axios/index.js"}],"src/Models/Users.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  User.buildUser = function (attrs) {
    return new User(new Eventing_1.Eventing(), new Sync_1.Sync(rootUrl), new Attributes_1.Attributes(attrs));
  };
...
exports.User = User;
},{"./Eventing":"src/Models/Eventing.ts","./Sync":"src/Models/Sync.ts","./Attributes":"src/Models/Attributes.ts","./Models":"src/Models/Models.ts","./Collection":"src/Models/Collection.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
if (root) {
  var userForm = new UserForms_1.UserForms(root, user);
  userForm.render();
}
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "41789" + '/');
